...
function createDataRouteMatcher(future, basename) {
	if (future.unstable_routePatternMatching) {
		...
		invariant$2(RoutePatternMatcher, "You must call unstable_preloadRoutePattern() from \"react-router/route-pattern\" before enabling future.unstable_routePatternMatching.");
...
function DataRoutes({ routes, manifest, state, isStatic, onError }) {
	let dataRouterContext = import_react.useContext(DataRouterContext);
	invariant$2(dataRouterContext, "You must render this element inside a <DataRouterContext.Provider> element");
...
*/
//#endregion
export { useFogOFWarDiscovery as $, useRoutes as $t, createBrowserRouter as A, replace as An, withHydrateFallbackProps as At, useSubmit as B, useMatches as Bt, BrowserRouter as C, defaultMapRouteProperties as Cn, createMemoryRouter as Ct, Link as D, matchRoutes as Dn, renderMatches as Dt, HistoryRouter as E, matchPath as En, hydrationRouteProperties as Et, useFormAction as F, createMemoryHistory as Fn, useHref as Ft, Links as G, useOutletContext as Gt, RemixErrorBoundary as H, useNavigation as Ht, useLinkClickHandler as I, createPath as In, useInRouterContext as It, Scripts as J, useRevalidator as Jt, Meta as K, useParams as Kt, usePrompt as L, invariant$2 as Ln, useLoaderData as Lt, useBeforeUnload as M, Action as Mn, useAsyncError as Mt, useFetcher as N, createBrowserHistory as Nn, useAsyncValue as Nt, NavLink as O, redirect as On, withComponentProps as Ot, useFetchers as P, createHashHistory as Pn, useBlocker as Pt, handleClientVersionMismatch as Q, useRouterState as Qt, useScrollRestoration as R, parsePath as Rn, useLocation as Rt, createStaticRouter as S, data as Sn, WithHydrateFallbackProps as St, HashRouter as T, isRouteErrorResponse as Tn, createRoutesFromElements as Tt, CRITICAL_CSS_DATA_ATTRIBUTE as U, useNavigationType as Ut, useViewTransitionState as V, useNavigate as Vt, FrameworkContext as W, useOutlet as Wt, getPatchRoutesOnNavigationFunction as X, useRouteError as Xt, setIsHydrated as Y, useRoute as Yt, getPathsWithAncestors as Z, useRouteLoaderData as Zt, isCookie as _, isMutationMethod as _n, Router as _t, RSCDefaultRootErrorBoundary as a, FetchersContext as an, decodeViaTurboStream as at, StaticRouter as b, RouterContextProvider as bn, WithComponentProps as bt, createMemorySessionStorage as c, RSCRouterContext as cn, singleFetchUrl as ct, createSessionStorage as d, IDLE_BLOCKER as dn, createSearchParams as dt, AwaitContextProvider as en, createClientRoutes as et, isSession as f, IDLE_FETCHER as fn, Await as ft, createCookie as g, hasInvalidProtocol as gn, Route as gt, ServerMode as h, createStaticHandler as hn, Outlet as ht, populateRSCRouteModules as i, DataRouterStateContext as in, SingleFetchRedirectSymbol as it, createHashRouter as j, resolvePath as jn, useActionData as jt, ScrollRestoration as k, redirectDocument as kn, withErrorBoundaryProps as kt, createCookieSessionStorage as l, RouteContext as ln, stripIndexParam as lt, setDevServerHooks as m, createRouter as mn, Navigate as mt, RSCStaticRouter as n, DataRouterDataContext as nn, noActionDefinedError as nt, RSCRouterGlobalErrorBoundary as o, LocationContext as on, getSingleFetchDataStrategyImpl as ot, createRequestHandler as p, IDLE_NAVIGATION as pn, MemoryRouter as pt, PrefetchPageLinks as q, useResolvedPath as qt, routeRSCServerRequest as r, DataRouterNavigationContext as rn, shouldHydrateRouteLoader as rt, href as s, NavigationContext as sn, getTurboStreamSingleFetchDataStrategy as st, getHydrationData as t, DataRouterContext as tn, createClientRoutesWithHMRRevalidationOptOut as tt, createSession as u, ViewTransitionContext as un, createRequestInit as ut, createRoutesStub as v, validateNavigationTarget as vn, RouterProvider as vt, Form as w, generatePath as wn, createRoutesFromChildren as wt, StaticRouterProvider as x, createContext as xn, WithErrorBoundaryProps as xt, ServerRouter as y, ErrorResponseImpl as yn, Routes as yt, useSearchParams as z, PROTOCOL_RELATIVE_URL_REGEX as zn, useMatch as zt };
